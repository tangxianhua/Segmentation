...
from origincode.losses import DICELossMultiClass

from torch.autograd import Variable
from torch.utils.data import DataLoader
import torchvision.transforms as tr

from DATALSTM import BraTSDatasetLSTM
from origincode.CLSTM import BDCLSTM
from origincode.models import *

# %% import transforms

UNET_MODEL_FILE = r'/media/fafafa/J_CCSA_X64F/UNet-Zoo-master/weights/cesi1-1-1-0.001'
#MODALITY = ["flair"]
...
#     DATA_FOLDER, transform=tr.ToTensor())
# test_loader = DataLoader(
#     dset_test, batch_size=args.test_batch_size, shuffle=False, num_workers=1)

dset_train = BraTSDatasetLSTM(
    DATA_FOLDER, train=True, im_size=[args.size, args.size],transform=tr.ToTensor(),
                              )
...
if args.train:
    for i in range(args.epochs):
        ...
        train(i)
        #test()
    model_path = os.path.join(r"/media/fafafa/J_CCSA_X64F/UNet-Zoo-master/weights",
                                  'cesilstm-final-{}-{}-{}'.format(args.batch_size, args.epochs, args.lr))
