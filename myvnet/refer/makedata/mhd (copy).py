...
#gtsavepath = r'I:\changedata\4stmhd\Test\gt'
#masksavepath = r'I:\changedata\4stmhd\Test\Mask'
#centersavepath = r'I:\changedata\4stmhd\Test\Center'
#contourpath = r'I:\changedata\4stmhd\Test\Contour'
corppath = r'I:\changedata\4stmhd\4stsample\Test\chamfer'
path1 = 'I:\changedata\Test'
for lala in range(1,51):
    if lala <= 9:
       filenum = '0' + str(lala)
       ...
       filenum = str(lala)
    # 路径和列表声明
    #PathDicom = "/home/fafafa/KERAS/dcmtemp"  # 与python文件同一个目录下的文件夹,存储dicom文件

    #SaveRawDicom = r"I:\changedata\Test\10\mhd"  # 与python文件同一个目录下的文件夹,用来存储mhd文件和raw文件
    lstFilesDCM = []
    L1 = []
    sub1 = '256'
    sub2 = 'chamfer'
    path = os.path.join(path1,filenum,sub1,sub2)
    ...
    SimpleITK.WriteImage(sitk_img, os.path.join(corppath, str(filenum)+"chamfer" + ".mhd"))
    #_segmentation