...
from traindata import Mytrain,Myvali,Mytraincenter
...
weightsavepath = '/content/gdrive/My Drive/Project/MHD/Result/traincentercross'
traintxtsavepath = '/content/gdrive/My Drive/Project/MHD/Result/traincentercross'

traintxtname     = '1traincentercross180F30.txt'

trainpngsavepath = '/content/gdrive/My Drive/Project/MHD/Result/traincentercross'


trainpngname = '1traincentercross180F30.png'
traincenterpngsavepath = '/content/gdrive/My Drive/Project/MHD/Result/traincentercross'
traincenterpngname  = '1traincentercross180F30.png'

trainallpngsavepath = '/content/gdrive/My Drive/Project/MHD/Result/traincentercross'
trainallpngname = '1traincentercross180F30.png'
...
def train(epoch):
    ...
    for batch_idx, (image, mask, center) in enumerate(trainloader):
        ...
        outputcenter = centermodel(output)
        losscenter = crosscriterion(outputcenter, center)
        ...
        model_path = os.path.join(weightsavepath,'1traincentercross180--{}-{}'.format(args.epochs, args.lr))
...
def vali():
    ...
    for batch_idx, (image, mask) in tqdm(enumerate(vloader)):
        ...
        output = model(image)
        valiloss += testcriterion(output, mask).item()
    ...
    with open(os.path.join('/content/gdrive/My Drive/Project/MHD/Result/traincentercross','1valicentercross180F30.txt'), 'w') as f:
    ...
    plt.plot(Vloss_list)
    plt.savefig(os.path.join('/content/gdrive/My Drive/Project/MHD/Result/traincentercross','1valicentercross180F30.png'))
...
if args.train:
    ...
    Vppv_list = []
    Vnpv_list = []
    path = r'/content/gdrive/My Drive/Project/MHD/Result/traincentercross/1traincentercross170--10-0.0001'
    model.load_state_dict(torch.load(path))
    print('load again')
